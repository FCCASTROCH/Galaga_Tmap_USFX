...
#define UE_PROJECT_NAME Galaga_Tmap_USFX
#define UE_TARGET_NAME Galaga_Tmap_USFXEditor
#define UE_MODULE_NAME "Galaga_Tmap_USFX"
...
#define GALAGA_TMAP_USFX_API DLLEXPORT
